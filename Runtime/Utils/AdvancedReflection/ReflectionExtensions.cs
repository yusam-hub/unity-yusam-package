...
namespace YusamPackage
{
    public static class ReflectionExtensions
    {
        ...
        public static bool MathCharacterNotInBracketsExists(string str)
        {
            ...
            return !AllCharacterAreInBrackets(str, '+') || !AllCharacterAreInBrackets(str, '-') ||
                   !AllCharacterAreInBrackets(str, '*') || !AllCharacterAreInBrackets(str, '/') ||
                   !AllCharacterAreInBrackets(str, '=') || !AllCharacterAreInBrackets(str, '%') ||
                   !AllCharacterAreInBrackets(str, '^');
        }
