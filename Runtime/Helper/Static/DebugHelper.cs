...
namespace YusamPackage
{
    ...
    {
        public static void DrawCircleXZ(Vector3 position, float radius, int segments, DebugProperties debugProperties)
        {
            if (!debugProperties.debugEnabled) return;
            ...
            for (var i = 0; i < segments; i++)
            {
                ...
                Debug.DrawLine(lineStart, lineEnd, debugProperties.debugLineColor, debugProperties.debugDuration);
            }
        }    
