...
namespace YusamPackage
{
    public static class DebugHelper
    {
        ...
        {
            DrawCircleStar(position, rotation, radius, 4, color, duration);
        }
        ...
        public static void DrawCircleStar(Vector3 position, Quaternion rotation, float radius, int segments, Color color, float duration)
        {
            // If either radius or number of segments are less or equal to 0, skip drawing
            if (radius <= 0.0f || segments <= 0)
            {
